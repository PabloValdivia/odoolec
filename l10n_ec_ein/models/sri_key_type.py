...
class SriKeyType(models.Model):
    ...
    file_content = fields.Binary("File", readonly=True, states=STATES)
    ...
    emision_date = fields.Date(string="Emission Date", readonly=True)
    expire_date = fields.Date(string="End Date", readonly=True)
    subject_serial_number = fields.Char(string="Serie Number", readonly=True)
